...
const FEATURED_POSTS: BlogPost[] = [
  {
	...
	{
		slug: 'criminal-defense-basics',
		title: 'Criminal Defense Basics: What Every Defendant Should Know',
		date: '2024-05-08',
		excerpt:
			'Essential information about criminal defense proceedings, your rights, and how to work with your attorney for the best possible outcome.',
		author: 'Chris Noriega',
		category: 'criminal-defense',
		content: '',
			...
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						Stay informed with our latest legal insights and updates on criminal
						defense matters.
					</p>
				</div>
